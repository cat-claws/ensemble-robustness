...
def attack_model(model, loss_fn, batchSize, valset, num_epochs):
    ...
    for (i, (inputs, labels)) in enumerate(val_loader):
        ...
        atk = torchattacks.PGD(model, eps=0.3, alpha=1/255, steps=num_epochs, random_start=False)
    ...
    return original_accuracy, original_losses, attacked_accuracy, attacked_losses